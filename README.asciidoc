...
This is an archive of the now defunct Snowman decompiler repository. This code belongs to it's original authors. This repository will not be open to any commits or pulls.
